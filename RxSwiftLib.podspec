#
#  Be sure to run `pod spec lint RxSwiftLib.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.license      = { :type => "MIT", :file => "MITLicense" }
  ...
  spec.author             = { "indrajeet" => "indrajeet.senger@radixweb.com" }
  # Or just: spec.author    = ""
  # spec.authors            = { "" => "" }
  ...
  spec.source_files  = "RxSwiftLib/*.{swift,h,m}"
